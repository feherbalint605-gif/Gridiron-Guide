      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
            onClick={() => !isUpdating && handleRoleSelect('athlete')}
          >
            <NeonCard className="p-8 cursor-pointer border-2 border-transparent hover:border-primary transition-all bg-black/40 h-full flex flex-col items-center justify-center gap-6">
              ...
              <Button className="w-full bg-primary text-black font-bold hover:bg-primary/80">
                SELECT ATHLETE
              </Button>
            </NeonCard>
          </motion.div>
          ...
          <motion.div
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            onClick={() => !isUpdating && handleRoleSelect('coach')}
          >
            <NeonCard className="p-8 cursor-pointer border-2 border-transparent hover:border-accent transition-all bg-black/40 h-full flex flex-col items-center justify-center gap-6">
              ...
              <Button variant="outline" className="w-full border-accent text-accent hover:bg-accent hover:text-black font-bold">
                SELECT COACH
              </Button>
            </NeonCard>
          </motion.div>
